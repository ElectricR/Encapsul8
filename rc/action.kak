...
define-command encapsul8-action-replace-with -hidden -params 1 %{
    ...
    evaluate-commands %{
        encapsul8-position-restore-last-search
        encapsul8-surround-add-pair-based-on %arg{1}
        encapsul8-position-restore-last-search
        encapsul8-highlight-pair
        execute-keys "d"
    }
    encapsul8-undo-save
    encapsul8-position-restore-user
...
define-command encapsul8-action-quick-replace -hidden %{
    encapsul8-resolve-char-alias %val{key} encapsul8_opt_quick_replace_resolve_char_hotkey
    ...
    on-key %{
        ...
        %sh{
            case $kak_key in
                ...
                "$kak_opt_encapsul8_mapping_action_surround_within_shortcut") echo encapsul8-surround-within-action-shortcut ;;
                "$kak_opt_encapsul8_mapping_action_surround_around_shortcut") echo encapsul8-surround-around-action-shortcut ;;
...
define-command encapsul8-action -docstring 'Search for a pair and perform an action on it' %{
